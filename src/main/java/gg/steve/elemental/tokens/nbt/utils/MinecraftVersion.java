package gg.steve.elemental.tokens.nbt.utils;
...
public enum MinecraftVersion {
    ...
    private static gg.steve.elemental.tokens.nbt.utils.MinecraftVersion version;
     ...
     */
    public static gg.steve.elemental.tokens.nbt.utils.MinecraftVersion getVersion() {
        if (version != null) {
            return version;
        }
        final String ver = Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3];
        try {
            version = gg.steve.elemental.tokens.nbt.utils.MinecraftVersion.valueOf(ver.replace("v", "MC"));
        } catch (IllegalArgumentException ex) {
            version = gg.steve.elemental.tokens.nbt.utils.MinecraftVersion.UNKNOWN;
        }
        return version;
    }
