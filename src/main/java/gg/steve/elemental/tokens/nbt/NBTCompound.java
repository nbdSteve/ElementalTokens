package gg.steve.elemental.tokens.nbt;

import gg.steve.elemental.tokens.nbt.utils.MinecraftVersion;
import gg.steve.elemental.tokens.nbt.utils.nmsmappings.ReflectionMethod;
...
public class NBTCompound {
    ...
    private gg.steve.elemental.tokens.nbt.NBTCompound parent;

    protected NBTCompound(gg.steve.elemental.tokens.nbt.NBTCompound owner, String name) {
     ...
     */
    public gg.steve.elemental.tokens.nbt.NBTCompound getParent() {
        return parent;
    }
     ...
     * @param comp
     */
    public void mergeCompound(gg.steve.elemental.tokens.nbt.NBTCompound comp) {
        try {
            writeLock.lock();
    ...
    public ItemStack getItemStack(String key) {
        try {
            readLock.lock();
            gg.steve.elemental.tokens.nbt.NBTCompound comp = getCompound(key);
     ...
     */
    public gg.steve.elemental.tokens.nbt.NBTCompound addCompound(String name) {
        try {
            writeLock.lock();
            if (getType(name) == NBTType.NBTTagCompound)
                return getCompound(name);
            NBTReflectionUtil.addNBTTagCompound(this, name);
            gg.steve.elemental.tokens.nbt.NBTCompound comp = getCompound(name);
            if (comp == null)
     ...
     */
    public gg.steve.elemental.tokens.nbt.NBTCompound getCompound(String name) {
        try {
            readLock.lock();
            if (getType(name) != NBTType.NBTTagCompound)
                return null;
            gg.steve.elemental.tokens.nbt.NBTCompound next = new gg.steve.elemental.tokens.nbt.NBTCompound(this, name);
